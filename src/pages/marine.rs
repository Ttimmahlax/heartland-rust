            ...
            div { class: "grid md:grid-cols-2 gap-10 md:gap-14 items-center",
                ...
                div { class: "animate-fade-in-up md:order-1 order-2",
                    ...
                    h2 { class: "text-3xl md:text-5xl font-bold leading-tight mb-6",
                        "Lightweight Fillers "
                        span { class: "text-gradient-red", "& Reinforcements" }
                    }
    ...
    rsx! {
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 md:gap-14 items-center",
                ...
                div { class: "animate-fade-in-up md:order-2 order-1",
                    p { class: "text-sm uppercase tracking-[0.2em] text-[color:var(--color-accent)] mb-4",
                        "Same Resin. More Value."
                    }
                    h2 { class: "text-3xl md:text-5xl font-bold leading-tight mb-6",
                        "Transition to Natural "
                        span { class: "text-gradient-red", "FIber Filled Composites" }
                    }
                    p { class: "text-lg font-medium text-[color:var(--color-accent)] mb-4",
                        "Heartland helps marine OEMs and suppliers lower the weight and carbon footprint of their raw materials."
                    }
                    p { class: "text-lg text-[color:var(--color-fg-muted)] mb-4 last:mb-0",
                        "Our additives are 60% to 80% lighter than traditional mined and synthetic plastic additives like fiberglass."
                    }
                }
                // Right: image
                div { class: "animate-fade-in-up md:order-1 order-2",
