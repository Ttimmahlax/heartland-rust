        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                ...
                div { class: "md:order-1",
                    img { src: "/assets/pages/imperium-graphene/1210x786-px-1.webp", alt: "Unlocking Applications For High Performance Carbons", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
                }
            }
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                ...
                div { class: "md:order-2",
                    img { src: "/assets/pages/imperium-graphene/imperium-carbon.webp", alt: "imperium carbon", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
                }
            }
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                ...
                div { class: "md:order-1",
                    img { src: "/assets/pages/imperium-graphene/imperium-filler.webp", alt: "Imperium Filler", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
                }
            }
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                ...
                div { class: "md:order-2",
                    img { src: "/assets/pages/imperium-graphene/talc-mining.webp", alt: "talc mining", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
                }
            }
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-graphene/plastic.webp", alt: "plastic", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-graphene/asphalt.webp", alt: "asphalt", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }
            ...
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-graphene/heartland-plastic-picture-3.webp", alt: "Markets We Amplify", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }        }
    }
}
