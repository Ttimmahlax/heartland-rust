...
#[component]
pub fn ImperiumCattleFeed() -> Element {
    rsx! {
        Seo {
            title: "Imperium Cattle Feed",
            description: "Imperium Cattle Feed is currently shipping throughout North America in full containers to ranchers looking for natural nutrition.",
            path: "/imperium-cattle-feed",
        }
        ...
        section {
            ...
            div { class: "video-hero-content container-content w-full py-24 md:py-32 text-center",
                ...
                p {
                    ...
                    "Imperium Cattle Feed is for ranchers looking for natural nutrition to raise more resilient and healthy livestock."
                }
            }
        }
    }
        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Imperium Cattle Feed Available In North America" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Imperium Cattle Feed is for ranchers looking for natural nutrition to raise more resilient and healthy livestock." }
                }
            ...
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Natural Nutrition That Saves You Money" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Imperium Cattle Feed is Hemp Grain." }
                            ...
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Imperium Cattle Feed can be used for raising cattle." }
                }
                div { class: "md:order-2",
            ...
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-cattle-feed/untitled-design-1-1.webp", alt: "Heartland Climate Disclosures Engage", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }        }
    }
}
