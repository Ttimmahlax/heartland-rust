...
#[component]
pub fn ImperiumPorkFeed() -> Element {
    rsx! {
        Seo {
            title: "Imperium Pork Feed",
            description: "Imperium Pork Feed is currently shipping throughout North America in full containers to ranchers looking for natural nutrition.",
            path: "/imperium-pork-feed",
        }
        ...
        section {
            ...
            div { class: "video-hero-content container-content w-full py-24 md:py-32 text-center",
                ...
                p {
                    ...
                    "Imperium Pork Feed is for ranchers looking for natural nutrition to raise more resilient and healthy livestock."
                }
            }
        }
    }
        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Imperium Pork Feed Available In North America" }
            ...
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Natural Nutrition That Saves You Money" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Imperium Pork Feed is Hemp Grain." }
