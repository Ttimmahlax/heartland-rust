...
fn Body() -> Element {
    rsx! {
        section { class: "container-content py-16 md:py-20",
            ...
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-chicken-feed/industry-5.0-article-series-1210-x-786-px-8.webp", alt: "Image of a computer screen with the title, Chief Sustainability Officer displayed", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }        }
    }
}
