        ...
        section {
            ...
            div { class: "video-hero-content container-content w-full py-24 md:py-32 text-center",
                ...
                h1 {
                    ...
                    "Sustainable packaging Additives"
                }
                p {
                    class: "mt-5 max-w-2xl mx-auto text-base md:text-lg text-white/85 animate-fade-in-up delay-1",
                    "Packaging is used throughout supply chains for all raw materials, products, and foods. Reducing the negative impact this packaging has on the environment is an easy starting point for companies with…"
                }
            }
        }
    }
        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Lower Carbon Footprint Everyday Products" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Packaging is used throughout supply chains for all raw materials, products, and foods. Reducing the negative impact this packaging has on the environment is an easy starting point for companies with a high carbon footprint." }
                }
                div { class: "md:order-1",
                    img {
                        src: "/assets/pages/sustainable-packaging/heartland-natural-fiber-filled-plastic-caps-and-closures.png",
                        alt: "Lower Carbon Footprint Everyday Products",
                        loading: "lazy",
            ...
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Packaging is Everywhere" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Heartland works alongside manufacturers across markets to explore sustainable packaging opportunities." }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Heartland's materials can be used as additives to augment minerals used in paper and plastic packaging. We believe that the future of packaging relies on supply chains of carbon-negative materials." }
                }
                div { class: "md:order-2",
                    img {
            ...
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "For Packaging Suppliers" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Heartland supplies lower-carbon-footprint materials to help packaging manufacturers and suppliers create stronger, lighter, cheaper, and more sustainable products." }
                }
                div { class: "md:order-1",
                    img {
