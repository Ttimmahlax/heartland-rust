        ...
        section {
            ...
            div { class: "video-hero-content container-content w-full py-24 md:py-32 text-center",
                ...
                p {
                    ...
                    "Reducing the weight of a vehicle increases its performance and reduces its carbon footprint. Lighter-weight vehicles can expect increased acceleration and fuel efficiency, as well as decreased…"
                }
            }
        }
    }
        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Lightweight & Lower Carbon Footprint Automotive Plastic" }
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Reducing the weight of a vehicle increases its performance and reduces its carbon footprint. Lighter-weight vehicles can expect increased acceleration and fuel efficiency, as well as decreased stopping force and stopping time." }
                }
                div { class: "md:order-1",
                    img {
                        src: "/assets/pages/automotive/heartland-natural-fiber-filled-plastic-car-at-starting-line.png",
                        alt: "Lightweight & Lower Carbon Footprint Automotive Plastic",
                        loading: "lazy",
            ...
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Unlocking The Sustainable Future We Need And Deserve" }
                            ...
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "Heartland's additives are 60% to 80% lighter than traditional mined and synthetic plastic additives." }
                }
                div { class: "md:order-2",
                    img {
                        src: "/assets/pages/automotive/heartland-natural-fiber-filled-plastic-car-part-5.png",
                        alt: "Unlocking The Sustainable Future We Need And Deserve",
                        loading: "lazy",
                        class: "w-full rounded-xl shadow-lg",
                    }
                }
            ...
            figure { class: "mb-16 animate-fade-in-up",
                img { src: "/assets/pages/imperium-masterbatch/imperium-filler.png", alt: "Imperium Filler", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
            }
            div { class: "max-w-3xl mx-auto mb-16 animate-fade-in-up",
                h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5 text-center", "Throughout The Supply Chain" }
                            ...
                            p { class: "text-[color:var(--color-fg-muted)] mb-4 last:mb-0", "_ Tier 1, 2, & 3 Supplier Heartland partners with plastic converters to ensure the hemp-filled resin is processed properly. Our team works alongside component part manufacturers to process natural fiber-filled plastic with the same molds used today." }
