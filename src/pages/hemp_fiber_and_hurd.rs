...
#[component]
pub fn HempFiberAndHurd() -> Element {
    rsx! {
        Seo {
            title: "Hemp Fiber and Hurd",
        ...
        section {
            ...
            div { class: "video-hero-content container-content w-full py-24 md:py-32 text-center",
                ...
                p {
                    ...
                    "Imperium Powder is for brands, converters, and suppliers that are looking for bio-based powders to replace or augment talc, calcium, and fiberglass."
                }
            }
        }
    }
        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-2",
                    h2 { class: "text-2xl md:text-3xl font-display font-bold mb-5", "Unlocking Commodity Fiber and Hurd Additives" }
