            ...
            div { class: "grid md:grid-cols-2 gap-10 md:gap-14 items-center",
                ...
                div { class: "animate-fade-in-up md:order-1 order-2",
                    ...
                    h2 { class: "text-3xl md:text-5xl font-bold leading-tight mb-6",
                        "Making The Built World "
                        span { class: "text-gradient-red", "With Carbon Negative Additives" }
                    }
                ...
                div { class: "animate-fade-in-up md:order-2 order-1",
                    img {
                        src: "/assets/pages/sustainable-building-materials/pouring-hemp-filled-concrete.webp",
                        alt: "",
                        loading: "lazy",
    ...
    rsx! {
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 md:gap-14 items-center",
                ...
                div { class: "animate-fade-in-up md:order-2 order-1",
                    p { class: "text-sm uppercase tracking-[0.2em] text-[color:var(--color-accent)] mb-4",
                        "Sustainability Engineered For Construction"
                    }
                    h2 { class: "text-3xl md:text-5xl font-bold leading-tight mb-6",
                        "An Economic Engine With "
                        span { class: "text-gradient-red", "A Lower Carbon Footprint" }
                    }
                    ...
                    p { class: "text-lg text-[color:var(--color-fg-muted)] mb-4 last:mb-0",
                        "Sustainable building materials are starting to become more common throughout Europe and North America. Heartland focuses on reducing the carbon footprint of building materials where it matters most."
                    }
                }
                // Right: image
                div { class: "animate-fade-in-up md:order-1 order-2",
                    img {
                        src: "/assets/pages/sustainable-building-materials/hemp-filled-concrete-skate-park.webp",
                        alt: "",
                        loading: "lazy",
                        class: "w-full rounded-xl shadow-lg",
                    }
