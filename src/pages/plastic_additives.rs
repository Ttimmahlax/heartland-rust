        ...
        section { class: "container-content py-16 md:py-20",
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                ...
                div { class: "md:order-1",
                    img { src: "/assets/pages/hemp-fiber-and-hurd/heartland-powder.webp", alt: "Unlocking Commodity Natural Fiber Additives", loading: "lazy", class: "w-full rounded-xl shadow-lg" }
                }
            }
            div { class: "grid md:grid-cols-2 gap-10 items-center mb-16 md:mb-24 animate-fade-in-up",
                div { class: "md:order-1",
