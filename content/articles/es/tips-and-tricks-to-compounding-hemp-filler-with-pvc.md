...
hero_alt = "relleno de cáñamo PVC"
...
## **The challenges associated with compounding hemp filler into PVC**
...
Hemp is one of the strongest natural fibers, but to unlock the performance benefits you need to properly bond the fiber to your PVC. The chemistry of hemp filler and PVC are different and need to be bonded together at a molecular level.
...
## **Tips and Tricks to see success compounding hemp filler with PVC on your first try.**

### Watch Your Temperature During Compounding

The strength of hemp fibers is a crucial performance factor. One of the biggest factors that damage the strength of the hemp filler is too much temperature. For PVC, we would recommend using a masterbatch version of hemp filler that is engineered to withstand the temperature of compounding and molding.
...
Hemp fiber bonds with hemp fiber really well. When you look to bond hemp fiber with PVC, they have a much harder time staying together. To functionalize hemp filler, you can utilize the same ingredients that you currently use to improve bonding for talc, calcium carbonate, or glass fiber.

This is important because you will see a significant increase in the performance of the composite by improved bonding with PVC.
