...
- The fastest planes on the planet are fighter jets used by the [US military](https://www.defense.gov/). On a commercial level, [SpaceX](https://www.spacex.com/) is launching and lands rockets on a monthly basis.
...
Airplanes, for example, made for commercial use by [Boeing](https://www.boeing.com/) and [Airbus](https://www.airbus.com/) will see massive implications from reducing the weight of each plane.
...
Fortunately, we already know that hemp has higher tensile strengths than aluminum and steel when compounded with different all different types of polymers. This has already been [proven by 3rd parties](/hemp-data/) across industry and academia.
