...
In many cases, the additives and formulas used in a specific grade of plastic are kept secret by the [plastic compounder or resin supplier](/sustainability-news/the-benefits-of-hemp-reinforced-polypropylene-for-automotive/). Naturally, this is done to protect the intellectual property (formula) of the compounded plastic. Secondarily, it prevents a manufacturer from shopping around to find different suppliers for the same plastic.
...
There are [literally hundreds of substances](https://www.sciencedirect.com/topics/chemistry/colorant#:~:text=The%20five%20colorant%20categories%20include,contain%20dispersants%20and%20other%20additives.) that may be added to plastics: colorants, flame retardants, plasticizers, UV stabilizers, impact modifiers, and dozens more. Many of the commonly used plastic additives are minerals like talc and calcium carbonate which have been in use for decades.
